...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-row w-full h-[7rem] place-items-center justify-between min-w-full">
      <section className="w-[60%] relative h-[5rem] rounded-lg flex flex-row place-items-center gap-9 bg-white">
        <svg
          className="ml-3"
        ...
        <input
          className="w-[90%] h-full text-2xl border-none outline-none text-black"
          type="search"
